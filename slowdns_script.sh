...
dnstt-client -doh https://cloudflare-dns.com/dns-query -pubkey $PUBKEY -mtu $MTU $tunnel_domain 127.0.0.1:8080

# Google DoH
dnstt-client -doh https://dns.google/dns-query -pubkey $PUBKEY -mtu $MTU $tunnel_domain 127.0.0.1:8080

# Quad9 DoH
dnstt-client -doh https://dns.quad9.net/dns-query -pubkey $PUBKEY -mtu $MTU $tunnel_domain 127.0.0.1:8080
