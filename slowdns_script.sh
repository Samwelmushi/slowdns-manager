...
# UDP optimization - CRITICAL for DNS speed
...
EOF
    ...
    log_success "System optimized with ULTRA buffers for maximum DNS tunnel speed"
    log_message "   - 256MB network buffers"
    log_message "   - 128KB UDP buffers (DNS critical)"
    log_message "   - BBR congestion control"
    log_message "   - 50K packet backlog"
}
